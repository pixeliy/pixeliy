// Sprite rendering (32×32) using base layers + outfit overlays from the atlas.
// - Feet bobbing and ±45° arm swing
// - Optional hair Y offset (default -16)
// - Optional hand item swings with the front arm, drawn behind it
