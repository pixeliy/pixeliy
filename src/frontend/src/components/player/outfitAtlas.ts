// Outfit atlas loader and registry (from /public/assets/set/set.png)
// Grid: 8×8, tile 32px. Register items by ID and grid coords, then build OutfitParts.
...
// Hand item can be a single tile or multiple 32×32 tiles with offsets
...
registerHair("hair_upper", 1, 0);
registerHair("hair_anime", 2, 0);
registerHair("hair_fanny", 3, 0);

registerFace("none", 7, 7);
registerFace("glasses", 0, 1);
registerFace("golden_glasses", 1, 1);

registerShirt("none", { cx: 0, cy: 0 });
