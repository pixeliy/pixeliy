// Outfit options are built from the atlas registry at runtime.
...
/**
 * Normalize slots from backend storage.
 * - If legacy binary ["1","0",...] => map to default IDs or "".
 * - If already ID-per-slot => keep values, pad to 6 items.
 */
