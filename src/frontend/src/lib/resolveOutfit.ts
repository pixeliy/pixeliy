// Build OutfitParts from an OutfitLibrary and the current slots.
// Supports legacy binary slots and new ID-per-slot format.
...
export const DEFAULT_OUTFIT_IDS = {
  ...
  shirt: "hoodie",
  pants: "black_short",
  shoes: "blue_sneakers", // match atlas registration
  handItem: "key",
  sleeves: true,
};
